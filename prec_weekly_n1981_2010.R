...
write_parquet(x = prec_normal, sink = "prec_weekly_normal_n1981_2010.parquet")
write_csv2(x = prec_normal, file = "prec_weekly_normal_n1981_2010.csv")
write_parquet(x = prec_indi, sink = "prec_weekly_indi_n1981_2010.parquet")
write_csv2(x = prec_indi, file = "prec_weekly_indi_n1981_2010.csv")
