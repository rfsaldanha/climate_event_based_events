...
write_parquet(x = rh_normal, sink = "rh_normal_monthly_n1961_1990.parquet")
write_csv2(x = rh_normal, file = "rh_normal_monthly_n1961_1990.csv")
write_parquet(x = rh_indi, sink = "rh_indi_monthly_n1961_1990.parquet")
write_csv2(x = rh_indi, file = "rh_indi_monthly_n1961_1990.csv")
