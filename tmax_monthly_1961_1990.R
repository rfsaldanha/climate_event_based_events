...
write_parquet(x = tmax_normal, sink = "tmax_monthly_normal_n1961_1990.parquet")
write_csv2(x = tmax_normal, file = "tmax_monthly_normal_n1961_1990.csv")
write_parquet(x = tmax_indi, sink = "tmax_monthly_indi_n1961_1990.parquet")
write_csv2(x = tmax_indi, file = "tmax_monthly_indi_n1961_1990.csv")
